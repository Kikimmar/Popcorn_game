...
void AsPlatform::Draw(HDC hdc, RECT& paint_area)
{
	...
	case EPS_Expand_Roll_In:
		Draw_Expand_Roll_In_State(hdc, paint_area);
		break;
	}
}
//------------------------------------------------------------------------------------------------------------
...
{// Рисуем платформу в нормальном состоянии
	...
	// 2. Рисуем блик
	Draw_Circle_Hilight(hdc, x * AsConfig::Global_Scale, y * AsConfig::Global_Scale);
...
{// Рисуем выкатыввающуюся платформу
	...
	Rectangle(hdc, - AsConfig::Global_Scale / 2, - roller_size / 2, AsConfig::Global_Scale / 2 + 1, roller_size / 2);
...
//------------------------------------------------------------------------------------------------------------
void AsPlatform::Draw_Expand_Roll_In_State(HDC hdc, RECT& paint_area)
{// Рисуем рвсширяющуюся после выкатыввания платформу
	Draw_Normal_State(hdc, paint_area);
