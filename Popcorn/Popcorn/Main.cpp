...
3. Анимация расширябщейся платформы
4. Пуск мяча пробелом и состояния мяча


Кирпичи
1.     Обычные кирпичи (синие или красные)
1.1.   Могут быть с буквой и без
1.2.   При попадании в кирпич он мсчезает из уровня сразу, и если кирпич был:
...
1. Падающая буква - взаимодействует с платформой
...
Действия букв
1.   Простые:
1.1. О ("Отмена") - отмена символов К, Ш, П, Л, М.
1.2. И ("Инверсия")
1.3. С ("Скорость")
1.4. М ("Монстры")
1.5. Ж ("Жизнь") — игрок получает дополнительную попытку.
...
2.2.2. Анимация расширения платформы (прямая и обратная)
...
2.6.   + (Переход на след уровень)
2.6.1. Анимация досрочного перехода на след уровень
2.6.2. Отдельный уровень с особыми стенками (рамкой)
...
2. Состояния игры(заставка/анимация начала уровня/ играем сам уровень/ потеря жизни/ переход на след уровень(нормальный и досрочный)/ окончание игры)
